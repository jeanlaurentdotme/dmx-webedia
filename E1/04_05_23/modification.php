            ...
            <table class="scene">
                <tr>
                    ...
                    while ($data = $resultat->fetch_assoc())
                    {
                        ...
                        <td class="tabscene" bgcolor="<?php echo $data['couleurscene'] ?>" id="<?php echo $data['id'] ?>" onclick="document.location.href='modifscene.php?id=<?php echo $data['id']?>&nom=<?php echo $data['nom']?>'"><?php echo $data['nom'] ?></td>
                        <?php
                        $nbscene++;
                    }
                    ?>
