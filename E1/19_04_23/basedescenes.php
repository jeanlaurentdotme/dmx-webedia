  ...
  -->
    ...
    function recup()
    {
	    for (let i=1; i<21; i++) 
        {
            ...
            {
  			    var enfant = tabid.childNodes;
                const d = [document.getElementById(c), enfant.id];
        ...
        <div height="1800px" width="100%">
            <div id="divConteneur1">
                <table class="base">
                    ...
                    <tr>
                        <td colspan="5" class="oui"><a href="user.php">Retour à l'interface</a><button onclick="recup()">Engistrer</button></td>
