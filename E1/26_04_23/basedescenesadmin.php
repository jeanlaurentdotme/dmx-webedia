    ...
    function recup()
    {
	    ...
	    for (let i=1; i<21; i++) 
        {
		    ...
		    if (tabid.hasChildNodes())
            {
                ...
                console.log(enfant);
                console.log(e);
                var donnees = donnees+"postab["+nbscene+"]="+i+"$idscene["+nbscene+"]="+e+"&";
                nbscene = nbscene + 1;
		    }
	    }
        ...
        <div height="1800px" width="100%">
            <div id="divConteneur1">
                <table class="base">
                    ...
                    <tr>
                        <td colspan="5" class="oui"><a href="admin.php">Retour à l'interface</a><button onclick="recup()">Engistrer</button></td>
