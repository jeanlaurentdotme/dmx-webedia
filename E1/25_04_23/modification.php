                ...
                <table class="scene">
                    ...
                    while($data = $resultat->fetch_assoc())
                    {
                        if($nbscene%5==0 AND $nbscene!=0)
                        {
                            ...
                            <tr class="div1">
                            <td class ="div1" bgcolor="<?php echo $data['couleurscene']?>" id="<?php echo $data['id']?>"><a href="modifscene.php?id=<?php echo $data['id']?>&nom=<?php echo $data['nom']?>"><?php echo $data['nom']?></a></td>
                            <?php
                        }
                        else
                        {
