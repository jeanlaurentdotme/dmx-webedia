...
<body>
    ...
    $sql = 'SELECT * FROM Scene WHERE id='.$idscene.';';
    ...
    <div height="1800px" width="100%">
        ...
        <div class="divclassiques">
            ...
            <form action="modifbdd.php" method="post">
                ...
                <br />
                Couleur de la 1ère lumière <input type="color" name="L1" value="<?php echo $L1 ?>">
                Couleur de la 2ème lumière <input type="color" name="L2" value="<?php echo $L2 ?>">
                Couleur de la 3ème lumière <input type="color" name="L3" value="<?php echo $L3 ?>">
                <br />
                <br />
