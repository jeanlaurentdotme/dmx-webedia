...
echo !empty($_POST['login']);
echo isset($_POST['mdp1']);
echo !empty($_POST['mdp1']);
echo isset($_POST['mdp2']);
echo !empty($_POST['mdp2']);
...
if (isset($_POST['inscription']) && $_POST['inscription'] == 'Inscription') 
{
   ...
   if ((isset($_POST['login']) && !empty($_POST['login'])) && (isset($_POST['mdp1']) && !empty($_POST['mdp1'])) && (isset($_POST['mdp2']) && !empty($_POST['mdp2'])))
   {
      ...
      {	
         ...
         if ($data[0] == 0)
         {
            $sql = 'INSERT INTO User(id, nom, login, password) VALUES("","'.$_POST['nom'].'","'.mysqli_escape_string($connexion, $_POST['login']).'","'.mysqli_escape_string($connexion, md5($_POST['mdp1'])).'")';
