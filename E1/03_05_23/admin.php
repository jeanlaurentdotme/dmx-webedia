        ...
        <div>
            <table class="divclassiques">
                <tr>
                    ...
                    // on parcourt la BDD et on recupère les positions du tableau ainsi que leurs scène par rapport à l'ID de l'utilisateur
                    ...
                    for ($i = 1; $i < 21; $i++)
                    {
                        ...
                        for ($j = 0; $j < $postab_length; $j++)
                        {
                            if ($i == $postab[$j])
                            {
                                ...
                                {
                                    ?>
                                    <td class="affichage" style=background-color:<?php echo $listescene['couleurscene'] ?> id="<?php echo $idscene[$j] ?>"><?php echo $listescene['nom'] ?></td>
                                    <?php
                                }
                                $result = 1;
                            }
                        ...
                        {
                            ?>
                            <td class="affichage" id="<?php echo $i ?>">Aucune scène</td>
                            <?php
                        }
