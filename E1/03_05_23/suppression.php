            ...
            <table class="scene">
                <tr>
                    ...
                    while ($data = $resultat->fetch_assoc())
                    {
                        ...
                        <td class="tabscene" bgcolor="<?php echo $data['couleurscene'] ?>" id="<?php echo $data['id'] ?>"><a href="supprscene.php?id=<?php echo $data['id'] ?>&nom=<?php echo $data['nom'] ?>" onclick="myFunction()"><?php echo $data['nom'] ?></a></td>
                        <?php
                        $nbscene++;
                    }
                    ?>
