...
if (isset($_POST['enregistrer']) && $_POST['enregistrer'] == 'Enregistrer') 
{
   ...
   if ((isset($_POST['nom']) && !empty($_POST['nom'])))
   {
      ...
      $sql = "UPDATE SceneTest SET nom='".mysqli_escape_string($connexion, $_POST['nom'])."', couleurscene='".mysqli_escape_string($connexion, $_POST['background'])."', L1='".mysqli_escape_string($connexion, $_POST['L1'])."', L2='".mysqli_escape_string($connexion, $_POST['L2'])."', L3='".mysqli_escape_string($connexion, $_POST['L3'])."' WHERE id=".$idscene.";";
