            ...
            <table class="base">
                <tr>
                    <td class="banner" colspan="5">
                        <img class="banner" src="images/webedia_banner.png" alt="Bannière de Webedia">
                    </td>
                </tr>
                <tr>
                    <td colspan="5" class="choix">
                        <a href="admin.php">Retour à l'interface</a>
                        <!-- bouton permettant de sauvegarder l'interface -->
                        <button class="save" id="button" value="<?php echo $iduser; ?>" onclick="recup()">Enregistrer</button>
                    </td>
                </tr>
